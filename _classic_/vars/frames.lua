...
function frames:bootUI( )
  ...
  local t = self:createText( f[ 'containers' ][ 2 ], 'You can use this if your configuration becomes corrupt. your modifications to game settings will persist. all configurations are repulled from Warcaft for a fresh DB', 8, 'warn' )
  ...
  local t = self:createText( f[ 'containers' ][ 2 ], 'WARNING! this resets your game configuration back to Blizzard default state', 8, 'warn' )
