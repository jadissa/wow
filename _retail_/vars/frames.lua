...
function frames:bootUI( )
  ...
  local t = self:createText( f[ 'containers' ][ 2 ], 'Some settings may only require a reload of your graphics', 9, 'warn' )
  ...
  local t = self:createText( f[ 'containers' ][ 2 ], 'Some settings require a full reload of your ui', 9, 'warn' )
